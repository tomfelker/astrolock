...
class StellariumConnection(threaded.ThreadedConnection):
    ...
    def loop(self):
        while not self.want_to_stop:
            ...
            self.axis_angles[0] = alt_rad * u.rad
            self.axis_angles[1] = az_rad * u.rad
            ...
            move_x = self.desired_axis_rates[1].to_value(u.rad / u.s) / depl
            move_y = self.desired_axis_rates[0].to_value(u.rad / u.s) / depl
